...
const GetInTouch = () => {
  ...
  return (
    <section
      ref={container}
      className="relative min-h-[10rem] h-[40vw] md:h-[30vw] lg:h-[45vw] 3xl:h-[36vw] max-w-screen"
    >
      <div className="absolute top-[50%] md:top-[32%] lg:top-1/2 left-1/2 -translate-x-1/2 lg:-translate-y-1/2 w-full">
