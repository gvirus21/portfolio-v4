...
const ParallaxCard = ({ className, dark = false }: CardProps) => (
  <div
    className={cn(
...
const GetInTouch = () => (
  <section className="relative h-[40vw] lg:h-[45vw] max-w-screen">
    <div className="absolute top-[40%] lg:top-1/2 left-1/2 -translate-x-1/2 lg:-translate-y-1/2 w-full">
