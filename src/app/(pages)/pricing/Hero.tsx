  ...
  return (
    <section className="relative h-screen w-screen max-w-full">
      <Copy delay={textAnimationDelay}>
        <p className="absolute left-0 bottom-10 xs:bottom-30 md:bottom-40 xl:bottom-20 3xl:bottom-32 font-light text-3xl lg:text-4xl xl:text-5xl 3xl:text-7xl w-[90%] lg:w-[90%] xl:leading-[3.4rem] 3xl:leading-20">
