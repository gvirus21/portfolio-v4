...
export const HeroSection = () => {
  return (
    <section className="relative h-screen md:max-h-[32rem] lg:max-h-[36rem] xl:max-h-none md:mt-20 max-w-screen overflow-hidden">
      ...
      <Copy delay={0.8}>
        <p className="absolute right-4 left-4 sm:left-10 xl:left-10 3xl:left-20 bottom-10 xs:bottom-10 md:bottom-10 lg:bottom-20 xl:bottom-40 3xl:bottom-48 xl:font-light text-3xl sm:text-4xl lg:text-4xl xl:text-5xl 3xl:text-8xl md:w-[75%] lg:w-[80%] xl:w-[80%] 3xl:w-[80%] lg:leading-[3rem] xl:leading-[3.5rem] 3xl:leading-[6.5rem] tracking-tight">
